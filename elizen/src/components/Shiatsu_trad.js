...
const ShiatsuTrad = () => {
    return (
        <div className="ShiatsuTrad">
            ...
            <img className="img_shiatsu_trad" src="../shiatsutrad.png" alt="img_shiatsu_trad"/>
            <p>
                ...
                Le shiatsu consiste à exercer des pressions avec les pouces ou les mains sur tout le corps, accompagnées d'étirements et de mobilisations des articulations. Cette méthode est à la fois rapide et efficace, car elle dynamise et libère les tensions dès les premières 30 minutes de pratique.

                Le shiatsu répond aux défis croissants liés au stress, aide à mieux connaître son corps, et favorise la confiance en soi, la créativité, l’intuition et la concentration. En entreprise, le shiatsu contribue à améliorer la qualité de vie au travail, à prévenir les risques psychosociaux et à réduire les risques de burnout. Il diminue le stress négatif, stimule la disponibilité intellectuelle et créative, et soulage les douleurs musculaires liées aux mauvaises postures.

                Le shiatsu est également un excellent moyen de booster l'énergie en cas de fatigue et de se détendre lors de périodes de surmenage. Il améliore la concentration et la clarté mentale, préserve la santé physique, mentale et émotionnelle, renforce le système immunitaire et active les processus d'auto-guérison.
