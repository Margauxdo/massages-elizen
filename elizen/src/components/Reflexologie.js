...
const Reflexologie = () => {
    return (
        <div className="Reflexologie">
            ...
            <img className="img_reflex" src="reflexologie.png" alt="img_reflex"/>
            <p>
                ...
                Une séance commence par un entretien personnalisé afin de discuter de votre bien-être, de vos sensations et de vos ressentis avant le début de la pratique. Vous vous allongez ensuite confortablement sur une table de massage, tout en restant habillé, et vous profitez de mouvements enveloppants sur les jambes et les pieds pour vous aider à vous détendre, le tout accompagné d'une musique douce propice à la relaxation.

                Ensuite, des pressions spécifiques et adaptées à vos besoins sont appliquées sur les zones réflexes des pieds, d'abord sans produit, puis, si nécessaire, avec une crème appropriée à la zone traitée.
